                    ...
                    <div class="form-group mt-20"
                        ...
                        <div class="form-group mb-20" style="margin-top: 15px;">
                            ...
                            <p class="text-muted" style="font-size: 0.8rem; margin-left: 26px; margin-top: 2px;">
                                Eğer bu izni **kapatırsanız** süreç "Sıkı Mod (Strict Mode)" ile korunur; süreç
                                başlatılırken kullanıcılar ekstra kimseyi projeye dahil edemez, sadece yukarıda seçtiğiniz
                                zorunlu grup süreci yönetir.
                            </p>
                        </div>
                    </div>
