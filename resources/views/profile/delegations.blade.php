...
@section('content')
    <div class="page-header">
        <h1 class="page-title">🤝 Vekalet Yönetimi</h1>
        <p class="text-muted">İzinli veya raporlu olduğunuz dönemlerde iş akışlarının durmaması için onay yetkilerinizi
            devredin.</p>
    </div>
    ...
    <div class="doc-detail-layout mt-20">
        <aside class="doc-tabs-sidebar card glass-card">
            <ul class="vertical-tabs" id="delegationTabs">
                <li class="tab-item active" data-target="tab-given">📤 Verdiğim Vekaletler</li>
                <li class="tab-item" data-target="tab-received">📥 Bana Verilen Vekaletler</li>
            </ul>
        </aside>
        ...
        <main class="doc-tab-content card glass-card">
            ...
            <div id="tab-given" class="tab-pane active">
                <h2 style="color: var(--primary-color); margin-bottom: 20px;">Yeni Vekalet Tanımla</h2>
                ...
                <form action="{{ route('profile.delegations.store') }}" method="POST" class="modern-form"
                    ...
                    <div class="metadata-grid-2col">
                        <div class="form-group">
                            <label>Vekil Tayin Edilecek Kişi <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label>Sebep <span class="text-danger">*</span></label>
                            <input type="text" name="reason" class="form-control"
                                placeholder="Örn: Yıllık İzin, Sağlık Raporu" required>
                            @error('reason')
                    ...
                    <div class="text-right mt-15">
                        <button type="submit" class="btn btn-primary pulse-animation">➕ Vekaleti Başlat</button>
                    </div>
                </form>

                <h3>Geçmiş ve Aktif Vekaletlerim</h3>
                <div class="table-responsive mt-15">
                    <table class="table modern-table">
                        <thead>
                            <tr>
                                <th>Vekil Personel</th>
                                <th>Tarih Aralığı</th>
                                <th>Sebep</th>
                                <th>Durum</th>
                                <th>İşlem</th>
                        ...
                        <tbody>
                            @forelse($given as $del)
                                <tr>
                                    ...
                                    <td style="font-size: 0.85rem;">
                                        ...
                                        <span class="text-muted">İle</span> <br>
                                    ...
                                    <td>
                                        <form action="{{ route('profile.delegations.destroy', $del->id) }}" method="POST"
                                            onsubmit="return confirm('Bu vekaleti iptal etmek istediğinize emin misiniz?');">
                                            @csrf @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted p-15">Henüz kimseye vekalet vermediniz.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div id="tab-received" class="tab-pane" style="display: none;">
                <h2 style="color: var(--warning-color); margin-bottom: 20px;">Bana Devredilen Yetkiler</h2>
                <div class="alert alert-warning mb-20">
                    💡 Aşağıdaki listede durumu <strong>"Aktif"</strong> olan kişilere ait iş akışlarını ve belge
                    onaylarını, kendi hesabınız üzerinden <strong>vekaleten</strong> gerçekleştirebilirsiniz.
                </div>
                ...
                <div class="table-responsive">
                    <table class="table modern-table">
                        <thead>
                            <tr>
                                <th>Yetkiyi Devreden (Asıl Sahip)</th>
                                <th>Tarih Aralığı</th>
                                <th>Sebep</th>
                                <th>Durum</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted p-15">Şu anda kimsenin vekili
                                        değilsiniz.</td>
                                </tr>
                            @endforelse
                        </tbody>
